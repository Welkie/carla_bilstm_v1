...
class BiLSTMRepresentation(nn.Module):
    """A PyTorch implementation of the BiLSTM for time series
    Attributes
    ----------
    in_channels: int
    ...
    def __init__(self, in_channels: int, hidden_size: int = 64, num_layers: int = 2) -> None:
        super().__init__()
        ...
        self.lstm = nn.LSTM(in_channels, hidden_size, num_layers, bidirectional=True, batch_first=True)
